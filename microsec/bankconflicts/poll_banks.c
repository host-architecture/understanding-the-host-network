...
static void update_log(int c){
    ...
    LOG[log_index % LOG_SIZE].bank2_count = latest_bank2_count;
    LOG[log_index % LOG_SIZE].bank3_count = latest_bank3_count;
...
void main_exit() {
    ...
    while(i<LOG_SIZE) {
        fprintf(log_file,"%d %lld %lld %d %d %d %d\n",
        i,
        LOG[i].l_tsc,
        LOG[i].td_ns,
        LOG[i].bank0_count,
